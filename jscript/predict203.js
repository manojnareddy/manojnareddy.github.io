...
(async function () {
	...
	model = await tf.loadModel('https://manojnareddy.github.io/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "https://manojnareddy.github.io/assets/samplepic.jpg")
